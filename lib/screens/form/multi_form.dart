...
import 'package:navigation_drawer/screens/form/user.dart';
            ...
            builder: (_) => Scaffold(
                  ...
                  body: ListView.builder(
                    ...
                    itemBuilder: (_, i) => ListTile(
                          ...
                          title: data[i].fullName != null ? Text(data[i]!.fullName!):Text(""),
                          subtitle: data[i].email != null ? Text(data[i]!.email!):Text(""),
                        ),
                  ),
                ),
          ),
